...
class RegisterPage: BasePage {
    ...
    func fillUserName(in container: XCUIElement, _ userName: String) {
    ...
    func fillPassword(in container: XCUIElement, _ password: String) {
    ...
    func fillConfirmPassword(in container: XCUIElement, _ confirmPassword: String) {
    ...
    func verifyCongratulationsModal() {
    ...
    func tapLogInButtonInModal(file: StaticString = #file, line: UInt = #line) {
    ...
    func verifyTextFieldValue(_ textField: XCUIElement, expectedValue: String, message: String) {
    ...
    func verifySecureFieldValue(_ secureField: XCUIElement, expectedPlaceholder: String, message: String) {
